...
### An Ecommerce art gallery allowing users to purchase various works of art
...
The site has been built with the intention for users to creat and build a user profile which will allow thm to track their order history and have full ownership and understanding of all purchases. Building this trust is essential for a healthy ecommerce business. The capabilities for anonymous users has also been encorporated into the site in order to encourage a high volume of online sales.
...
![Ru Design ](../media/all-devices-black.jpg? "Title")
...
![Ru Design wireframe](../media/ru_design_wireframe.jpg?raw=true "Title")
